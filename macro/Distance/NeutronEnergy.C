...
void NeutronEnergy(bool beammode) {
  ...
  TH1F* h1_BefSIn_numu = (TH1F*)fin_numu->Get("NTagAnalysis/h1_GenBefSInE");
  TH1F* h1_SIn_numu    = (TH1F*)fin_numu->Get("NTagAnalysis/h1_GenSInE");

  TH1F* h1_BefSIn_numubar = (TH1F*)fin_numubar->Get("NTagAnalysis/h1_GenBefSInE");
  TH1F* h1_SIn_numubar    = (TH1F*)fin_numubar->Get("NTagAnalysis/h1_GenSInE");
  ...
  THStack* hs_nE = new THStack("hs_nE", "Neutron Energy; Generated Neutron Energy[MeV]; Number of Events");
#if fhcflag
  hs_nE -> Add(h1_SIn_numubar);
  hs_nE -> Add(h1_SIn_numu);
  hs_nE -> Add(h1_BefSIn_numubar);
  hs_nE -> Add(h1_BefSIn_numu);
#endif
#if rhcflag
  hs_nE -> Add(h1_SIn_numu);
  hs_nE -> Add(h1_SIn_numubar);
  ...
  c1 -> SetGrid();
  if (beammode) hs_nE -> SetMaximum(FrameMaximum);
  else hs_nE -> SetMaximum(50);
  hs_nE -> Draw();
  c1 -> RedrawAxis();
