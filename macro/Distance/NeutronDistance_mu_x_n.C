...
void NeutronDistance_mu_x_n(bool beammode) {
  ...
  legend1 -> AddEntry(h1_distance_nu_n, "#mu decay - n(from #nu) capture vtx", "L");
  legend1 -> AddEntry(h1_distance_mu_n, "#mu capture - n(from #mu) capture vtx", "L");
