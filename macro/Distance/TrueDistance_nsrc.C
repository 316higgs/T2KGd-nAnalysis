...
void TrueDistance_nsrc(bool beammode) {
...
#if 1
  TH1F* h1_PrmFSI_numu    = (TH1F*)fin_numu->Get("DistanceViewer/h1_truedistance_BefSIn");
  TH1F* h1_SI_numu  = (TH1F*)fin_numu->Get("DistanceViewer/h1_truedistance_SIn");
  TH1F* h1_MuCap_numu = (TH1F*)fin_numu->Get("DistanceViewer/h1_truedistance_MuCapn");
  h1_PrmFSI_numu -> SetStats(0);

  TH1F* h1_PrmFSI_nuesig    = (TH1F*)fin_nuesig->Get("DistanceViewer/h1_truedistance_BefSIn");
  TH1F* h1_SI_nuesig  = (TH1F*)fin_nuesig->Get("DistanceViewer/h1_truedistance_SIn");
  TH1F* h1_MuCap_nuesig = (TH1F*)fin_nuesig->Get("DistanceViewer/h1_truedistance_MuCapn");
  h1_PrmFSI_nuesig -> SetStats(0);

  TH1F* h1_PrmFSI_numubar    = (TH1F*)fin_numubar->Get("DistanceViewer/h1_truedistance_BefSIn");
  TH1F* h1_SI_numubar  = (TH1F*)fin_numubar->Get("DistanceViewer/h1_truedistance_SIn");
  TH1F* h1_MuCap_numubar = (TH1F*)fin_numubar->Get("DistanceViewer/h1_truedistance_MuCapn");
  h1_PrmFSI_numubar -> SetStats(0);

  TH1F* h1_PrmFSI_nuebarsig     = (TH1F*)fin_nuebarsig->Get("DistanceViewer/h1_truedistance_BefSIn");
  TH1F* h1_SI_nuebarsig   = (TH1F*)fin_nuebarsig->Get("DistanceViewer/h1_truedistance_SIn");
  TH1F* h1_MuCap_nuebarsig  = (TH1F*)fin_nuebarsig->Get("DistanceViewer/h1_truedistance_MuCapn");
  h1_PrmFSI_nuebarsig -> SetStats(0);

  TH1F* h1_PrmFSI_nuebkg    = (TH1F*)fin_nuebkg->Get("DistanceViewer/h1_truedistance_BefSIn");
  TH1F* h1_SI_nuebkg  = (TH1F*)fin_nuebkg->Get("DistanceViewer/h1_truedistance_SIn");
  TH1F* h1_MuCap_nuebkg = (TH1F*)fin_nuebkg->Get("DistanceViewer/h1_truedistance_MuCapn");
  h1_PrmFSI_nuebkg -> SetStats(0);

  TH1F* h1_PrmFSI_nuebarbkg    = (TH1F*)fin_nuebarbkg->Get("DistanceViewer/h1_truedistance_BefSIn");
  TH1F* h1_SI_nuebarbkg  = (TH1F*)fin_nuebarbkg->Get("DistanceViewer/h1_truedistance_SIn");
  TH1F* h1_MuCap_nuebarbkg = (TH1F*)fin_nuebarbkg->Get("DistanceViewer/h1_truedistance_MuCapn");
...
#if fhcflag
  hs_Distance -> Add(h1_MuCap_nuebarbkg);
  hs_Distance -> Add(h1_MuCap_nuebkg);
  hs_Distance -> Add(h1_MuCap_nuebarsig);
  hs_Distance -> Add(h1_MuCap_nuesig);
  hs_Distance -> Add(h1_MuCap_numubar);
  hs_Distance -> Add(h1_MuCap_numu);

  hs_Distance -> Add(h1_SI_nuebarbkg);
  hs_Distance -> Add(h1_SI_nuebkg);
  hs_Distance -> Add(h1_SI_nuebarsig);
  hs_Distance -> Add(h1_SI_nuesig);
  hs_Distance -> Add(h1_SI_numubar);
  hs_Distance -> Add(h1_SI_numu);

  hs_Distance -> Add(h1_PrmFSI_nuebarbkg);
  hs_Distance -> Add(h1_PrmFSI_nuebkg);
  hs_Distance -> Add(h1_PrmFSI_nuebarsig);
  hs_Distance -> Add(h1_PrmFSI_nuesig);
  hs_Distance -> Add(h1_PrmFSI_numubar);
  hs_Distance -> Add(h1_PrmFSI_numu);
#endif
  ...
  h1 -> SetStats(0);
  h1 -> SetLineWidth(2);
  h1 -> Add(h1_MuCap_nuebarbkg);
  h1 -> Add(h1_MuCap_nuebkg);
  h1 -> Add(h1_MuCap_nuebarsig);
  h1 -> Add(h1_MuCap_nuesig);
  h1 -> Add(h1_MuCap_numubar);
  h1 -> Add(h1_MuCap_numu);

  h1 -> Add(h1_SI_nuebarbkg);
  h1 -> Add(h1_SI_nuebkg);
  h1 -> Add(h1_SI_nuebarsig);
  h1 -> Add(h1_SI_nuesig);
  h1 -> Add(h1_SI_numubar);
  h1 -> Add(h1_SI_numu);

  h1 -> Add(h1_PrmFSI_nuebarbkg);
  h1 -> Add(h1_PrmFSI_nuebkg);
  h1 -> Add(h1_PrmFSI_nuebarsig);
  h1 -> Add(h1_PrmFSI_nuesig);
  h1 -> Add(h1_PrmFSI_numubar);
  h1 -> Add(h1_PrmFSI_numu);
  ...
  c1 -> SetGrid();
  if (beammode) hs_Distance -> SetMaximum(20);
  hs_Distance -> Draw();
  hs_Distance ->GetYaxis()->SetTitleSize(0.038);
  hs_Distance ->GetYaxis()->SetTitleOffset(1.3);
  hs_Distance ->GetYaxis()->SetLabelSize(0.036);
  hs_Distance ->GetXaxis()->SetTitle("Truth Distance btw #nu and n capture vertices [m]");
  hs_Distance ->GetYaxis()->SetTitle("Number of Truth Neutrons");
  hs_Distance -> Draw();
  //h1 -> SetMaximum(20);
  //h1 -> Draw();
  c1 -> RedrawAxis();
