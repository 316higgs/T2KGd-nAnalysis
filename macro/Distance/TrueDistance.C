...
void TrueDistance(bool beammode) {
...
#if fhcflag
  hs_Distance -> Add(h1_NC_nuebarbkg);
  hs_Distance -> Add(h1_NC_nuebkg);
  hs_Distance -> Add(h1_NC_nuebarsig);
  hs_Distance -> Add(h1_NC_numubar);
  hs_Distance -> Add(h1_NC_nuesig);
  hs_Distance -> Add(h1_NC_numu);

  hs_Distance -> Add(h1_CCOther_nuebarbkg);
  hs_Distance -> Add(h1_CC2p2h_nuebarbkg);
  hs_Distance -> Add(h1_CCQE_nuebarbkg);
  hs_Distance -> Add(h1_CCOther_nuebkg);
  hs_Distance -> Add(h1_CC2p2h_nuebkg);
  hs_Distance -> Add(h1_CCQE_nuebkg);
  hs_Distance -> Add(h1_CCOther_nuebarsig);
  hs_Distance -> Add(h1_CC2p2h_nuebarsig);
  hs_Distance -> Add(h1_CCQE_nuebarsig);
  hs_Distance -> Add(h1_CCOther_nuesig);
  hs_Distance -> Add(h1_CC2p2h_nuesig);
  hs_Distance -> Add(h1_CCQE_nuesig);

  hs_Distance -> Add(h1_CCOther_numubar);
  hs_Distance -> Add(h1_CCOther_numu);
  hs_Distance -> Add(h1_CC2p2h_numubar);
  hs_Distance -> Add(h1_CC2p2h_numu);
  hs_Distance -> Add(h1_CCQE_numubar);
  hs_Distance -> Add(h1_CCQE_numu);
#endif
