...
void TrueEkin_CapN(bool beammode) {
  ...
  TString hname_GenBefSI        = "NTagAnalysis/h1_GenBefSIEkin";
  TString hname_CapBefSI        = "NTagAnalysis/h1_CapBefSIEkin";
  TString hname_CapAftSI        = "NTagAnalysis/h1_CapSIEkin";
  ...
  TH1F* h1_GenBefSI = new TH1F("h1_GenBefSI", "", 100, 0, 200);
  ...
  TH1F* h1_CapBefSI = new TH1F("h1_CapBefSI", "", 100, 0, 200);
  ...
  TH1F* h1_CapAftSI = new TH1F("h1_CapAftSI", "", 100, 0, 200);
  ...
  h1_CapBefSI ->GetXaxis()->SetTitle("Truth Neutron Kinetic Energy [MeV]");
