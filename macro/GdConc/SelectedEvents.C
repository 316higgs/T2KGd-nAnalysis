...
// Tagged neutrons
  ...
  TH1F* h1_NuEvt_merge = new TH1F("h1_NuEvt_merge", "", 6, 0, 6);
  h1_NuEvt_merge -> Add(h1_NC_nuebarbkg);
  h1_NuEvt_merge -> Add(h1_NC_nuebkg);
  h1_NuEvt_merge -> Add(h1_NC_nuebarsig);
  h1_NuEvt_merge -> Add(h1_NC_numubar);
  h1_NuEvt_merge -> Add(h1_NC_nuesig);
  h1_NuEvt_merge -> Add(h1_NC_numu);

  h1_NuEvt_merge -> Add(h1_CCOther_nuebarbkg);
  h1_NuEvt_merge -> Add(h1_CC2p2h_nuebarbkg);
  h1_NuEvt_merge -> Add(h1_CCQE_nuebarbkg);
  h1_NuEvt_merge -> Add(h1_CCOther_nuebkg);
  h1_NuEvt_merge -> Add(h1_CC2p2h_nuebkg);
  h1_NuEvt_merge -> Add(h1_CCQE_nuebkg);
  h1_NuEvt_merge -> Add(h1_CCOther_nuebarsig);
  h1_NuEvt_merge -> Add(h1_CC2p2h_nuebarsig);
  h1_NuEvt_merge -> Add(h1_CCQE_nuebarsig);
  h1_NuEvt_merge -> Add(h1_CCOther_nuesig);
  h1_NuEvt_merge -> Add(h1_CC2p2h_nuesig);
  h1_NuEvt_merge -> Add(h1_CCQE_nuesig);

  h1_NuEvt_merge -> Add(h1_CCOther_numubar);
  h1_NuEvt_merge -> Add(h1_CCOther_numu);
  h1_NuEvt_merge -> Add(h1_CC2p2h_numubar);
  h1_NuEvt_merge -> Add(h1_CC2p2h_numu);
  h1_NuEvt_merge -> Add(h1_CCQE_numubar);
  h1_NuEvt_merge -> Add(h1_CCQE_numu);
  ...
  TString foutname = TString::Format("output/SelectedNuEvents.Gdconc%f.root", Gdconc);
  TFile* fout = new TFile(foutname, "RECREATE");
  fout -> cd();
  h1_NuEvt_merge  -> Write();
  h1_SelEff_merge -> Write();
