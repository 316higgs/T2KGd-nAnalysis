...
void DistanceImpact() {
  ...
  NoNTagCCQE[0]  = 0.733; //0 m
  NoNTagCCQE[1]  = 0.733; //1 m
  NoNTagCCQE[2]  = 0.729; //2 m
  NoNTagCCQE[3]  = 0.726; //3 m
  NoNTagCCQE[4]  = 0.724; //4 m

  SelEffCCQE[0]  = 0.203; //0 m
  SelEffCCQE[1]  = 0.917; //1 m
  SelEffCCQE[2]  = 0.930; //2 m
  SelEffCCQE[3]  = 0.932; //3 m
  SelEffCCQE[4]  = 0.933; //4 m
  ...
  NoNTagCC2p2h[0]  = 0.100;   //0 m
  NoNTagCC2p2h[1]  = 0.100;   //1 m
  NoNTagCC2p2h[2]  = 0.100;   //2 m
  NoNTagCC2p2h[3]  = 0.0998;  //3 m
  NoNTagCC2p2h[4]  = 0.0994;  //4 m

  SelEffCC2p2h[0]  = 0.206;  //0 m
  SelEffCC2p2h[1]  = 0.903;  //1 m
  SelEffCC2p2h[2]  = 0.918;  //2 m
  SelEffCC2p2h[3]  = 0.920;  //3 m
  SelEffCC2p2h[4]  = 0.921;  //4 m
  ...
  float SelEffCCOther[DATAPOINTS];
  ...
  NoNTagCCOther[0]  = 0.119;   //0 m
  NoNTagCCOther[1]  = 0.119;   //1 m
  NoNTagCCOther[2]  = 0.124;   //2 m
  NoNTagCCOther[3]  = 0.128;   //3 m
  NoNTagCCOther[4]  = 0.130;   //4 m

  SelEffCCOther[0]  = 0.0397;  //0 m
  SelEffCCOther[1]  = 0.161;   //1 m
  SelEffCCOther[2]  = 0.173;   //2 m
  SelEffCCOther[3]  = 0.177;   //3 m
  SelEffCCOther[4]  = 0.179;   //4 m
  ...
  NoNTagNC[0]  = 0.0477;   //0 m
  NoNTagNC[1]  = 0.0477;   //1 m
  NoNTagNC[2]  = 0.0468;   //2 m
  NoNTagNC[3]  = 0.0465;   //3 m
  NoNTagNC[4]  = 0.0463;   //4 m

  SelEffNC[0]  = 0.0418;   //0 m
  SelEffNC[1]  = 0.0418;   //1 m
  SelEffNC[2]  = 0.0418;   //2 m
  SelEffNC[3]  = 0.0418;   //3 m
  SelEffNC[4]  = 0.0418;   //4 m
  ...
  g_NoNTag_CCQE -> SetMarkerColor(kAzure-1);
  g_NoNTag_CCQE -> SetMarkerStyle(20);
  g_NoNTag_CCQE -> SetMarkerSize(1.5);
  TGraph* g_SelEff_CCQE = new TGraph(DATAPOINTS, NeutronDistance, SelEffCCQE);
  g_SelEff_CCQE -> SetLineColor(kAzure-1);
  g_SelEff_CCQE -> SetLineWidth(2);
  g_SelEff_CCQE -> SetMarkerColor(kAzure-1);
  g_SelEff_CCQE -> SetMarkerStyle(22);
  g_SelEff_CCQE -> SetMarkerSize(1.5);
  ...
  g_NoNTag_CC2p2h -> SetMarkerColor(kAzure-5);
  g_NoNTag_CC2p2h -> SetMarkerStyle(20);
  g_NoNTag_CC2p2h -> SetMarkerSize(1.5);
  TGraph* g_SelEff_CC2p2h = new TGraph(DATAPOINTS, NeutronDistance, SelEffCC2p2h);
  g_SelEff_CC2p2h -> SetLineColor(kAzure-5);
  g_SelEff_CC2p2h -> SetLineWidth(2);
  g_SelEff_CC2p2h -> SetMarkerColor(kAzure-5);
  g_SelEff_CC2p2h -> SetMarkerStyle(22);
  g_SelEff_CC2p2h -> SetMarkerSize(1.5);
  ...
  g_NoNTag_CCOther -> SetMarkerColor(kCyan-8);
  g_NoNTag_CCOther -> SetMarkerStyle(20);
  g_NoNTag_CCOther -> SetMarkerSize(1.5);
  TGraph* g_SelEff_CCOther = new TGraph(DATAPOINTS, NeutronDistance, SelEffCCOther);
  g_SelEff_CCOther -> SetLineColor(kCyan-8);
  g_SelEff_CCOther -> SetLineWidth(2);
  g_SelEff_CCOther -> SetMarkerColor(kCyan-8);
  g_SelEff_CCOther -> SetMarkerStyle(22);
  g_SelEff_CCOther -> SetMarkerSize(1.5);
  ...
  g_NoNTag_NC -> SetMarkerColor(kTeal+9);
  g_NoNTag_NC -> SetMarkerStyle(20);
  g_NoNTag_NC -> SetMarkerSize(1.5);
  TGraph* g_SelEff_NC = new TGraph(DATAPOINTS, NeutronDistance, SelEffNC);
  g_SelEff_NC -> SetLineColor(kTeal+9);
  g_SelEff_NC -> SetLineWidth(2);
  g_SelEff_NC -> SetMarkerColor(kTeal+9);
  g_SelEff_NC -> SetMarkerStyle(22);
  g_SelEff_NC -> SetMarkerSize(1.5);
  ...
  TText* textCCQE1 = new TText(3., 0.8, "CCQE");
  textCCQE1 -> SetTextSize(0.07);
  textCCQE1 -> SetTextColor(kAzure-1);
  TText* textCC2p2h1 = new TText(2.6, 0.8, "CC-2p2h");
  ...
  frame1 -> SetYTitle("Separation Purity and Efficiency in Sample");
  frame1 -> SetTitleOffset(1.2, "Y");
  g_NoNTag_CCQE -> Draw("PL");
  g_SelEff_CCQE -> Draw("SAMEPL");
  ...
  legend1 -> AddEntry(g_NoNTag_CCQE, "Purity", "LP");
  legend1 -> AddEntry(g_SelEff_CCQE, "Efficiency", "LP");
  ...
  frame2 -> SetYTitle("Separation Purity and Efficiency in Sample");
  frame2 -> SetTitleOffset(1.2, "Y");
  g_NoNTag_CC2p2h -> Draw("PL");
  g_SelEff_CC2p2h -> Draw("SAMEPL");
  ...
  legend2 -> AddEntry(g_NoNTag_CC2p2h, "Purity", "LP");
  legend2 -> AddEntry(g_SelEff_CC2p2h, "Efficiency", "LP");
  ...
  frame3 -> SetYTitle("Separation Purity and Efficiency in Sample");
  frame3 -> SetTitleOffset(1.2, "Y");
  g_NoNTag_CCOther -> Draw("PL");
  g_SelEff_CCOther -> Draw("SAMEPL");
  ...
  legend3 -> AddEntry(g_NoNTag_CCOther, "Purity", "LP");
  legend3 -> AddEntry(g_SelEff_CCOther, "Efficiency", "LP");
  ...
  frame4 -> SetYTitle("Separation Purity and Efficiency in Sample");
  frame4 -> SetTitleOffset(1.2, "Y");
  g_NoNTag_NC -> Draw("PL");
  g_SelEff_NC -> Draw("SAMEPL");
  ...
  legend4 -> AddEntry(g_NoNTag_NC, "Purity", "LP");
  legend4 -> AddEntry(g_SelEff_NC, "Efficiency", "LP");
