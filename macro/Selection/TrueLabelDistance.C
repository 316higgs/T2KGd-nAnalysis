...
void TrueLabelDistance(bool beammode) {
  ...
  TH1F* h1_mudecay_numu = (TH1F*)fin_numu->Get("DistanceViewer/h1_TruePrmMuEnd_x_fQDcyE_MuDcy");
  TH1F* h1_pidecay_numu = (TH1F*)fin_numu->Get("DistanceViewer/h1_TruePrmMuEnd_x_fQDcyE_PiDcy");
  h1_mudecay_numu -> SetStats(0);

  TH1F* h1_mudecay_numubar = (TH1F*)fin_numubar->Get("DistanceViewer/h1_TruePrmMuEnd_x_fQDcyE_MuDcy");
  TH1F* h1_pidecay_numubar = (TH1F*)fin_numubar->Get("DistanceViewer/h1_TruePrmMuEnd_x_fQDcyE_PiDcy");
