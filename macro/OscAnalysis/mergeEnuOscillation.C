...
void mergeEnuOscillation(bool beammode) {
  ...
  //TH1F* h1_CCnonQE_nuebarsig_wTagN = (TH1F*)fin_nuebarsig->Get("NeutrinoOscillation/h1_OscProbCCnonQE_wNeutron");
  ...
  //TH1F* h1_CCnonQE_nuebarsig_woTagN = (TH1F*)fin_nuebarsig->Get("NeutrinoOscillation/h1_OscProbCCnonQE_woNeutron");
