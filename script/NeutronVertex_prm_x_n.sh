...
make cleanNeutronVertex_prm_x_n
make NeutronVertex_prm_x_n.exe

if [ ! -f ./NeutronVertex_prm_x_n.exe ]; then
  exit 2
fi
...
#### FHC numu x numu #####
<<COMMENTOUT
./NeutronVertex_prm_x_n.exe $FITQUNDIR/0026Gd.numu/noinpmt/numu_x_numu.fiTQun.0026Gd.NEUTcount0\*.part00\*.skip\*.root\
                     $NTAGDIR/tageoption/noinpmt/numu_x_numu.ntag.0026Gd.NEUTcount0\*.part00\*.skip\*.root\
                     $ANALYSISSTAGE/output/fhc/fhc.numu_x_numu.NeutronVertex_prm_x_n.root\
                     $ANALYSISSTAGE/result/fhc/fhc.numu_x_numu.neutrino.NeutronVertex_prm_x_n.txt\
                     $ANALYSISSTAGE/result/fhc/fhc.numu_x_numu.ntag.NeutronVertex_prm_x_n.txt\
                     -MCType Gd\
                     -ETAG ON\
                     -BEAMMODE FHC\
                     -OSCCH NUMU
...
#<<COMMENTOUT
./NeutronVertex_prm_x_n.exe $FITQUNDIR/0026Gd.numubar/noinpmt/numubar_x_numubar.fiTQun.0026Gd.NEUTcount0\*.part00\*.skip\*.root\
                   $NTAGDIR/tageoption/noinpmt/numubar_x_numubar.ntag.0026Gd.NEUTcount0\*.part00\*.skip\*.root\
                   ./output/fhc/fhc.numubar_x_numubar.NeutronVertex_prm_x_n.root\
                   ./result/fhc/fhc.numubar_x_numubar.neutrino.NeutronVertex_prm_x_n.txt\
                   ./result/fhc/fhc.numubar_x_numubar.ntag.NeutronVertex_prm_x_n.txt\
                   -MCType Gd\
                   -ETAG ON\
                   -BEAMMODE FHC\
                   -OSCCH NUMUBAR
